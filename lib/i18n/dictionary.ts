...
export const dictionary: Record<string, Entry> = {
  ...
  "f_company": { uz: "Kompaniya", ru: "Компания" },
  "f_about": { uz: "Biz haqimizda", ru: "О нас" },
  "f_careers": { uz: "Vakansiyalar", ru: "Вакансии" },
  "f_blog": { uz: "Blog", ru: "Блог" },
  ...
  "f_social": { uz: "Ijtimoiy tarmoqlar", ru: "Соцсети" },
