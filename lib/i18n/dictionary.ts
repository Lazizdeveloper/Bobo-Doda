...
export const dictionary: Record<string, Entry> = {
  ...
  "help.paymentTitle": { uz: "To'lovlar", ru: "Платежи" },
  "help.paymentDesc": { uz: "Escrow, qaytarish va pul yechish", ru: "Эскроу, возвраты и вывод средств" },
  "help.contractTitle": { uz: "Shartnomalar", ru: "Контракты" },
  "help.contractDesc": { uz: "Bosqichlar, topshirish va qabul qilish", ru: "Этапы, сдача и приёмка" },
  "help.securityTitle": { uz: "Xavfsizlik", ru: "Безопасность" },
  "help.securityDesc": { uz: "Hisob, verifikatsiya va shubhali faoliyat", ru: "Аккаунт, верификация и подозрительная активность" },
