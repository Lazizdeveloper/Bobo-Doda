...
export const dictionary: Record<string, Entry> = {
  ...
  "nav_specialists": { uz: "Mutaxassislar uchun", ru: "Специалистам" },
  "nav_clients": { uz: "Xaridorlar uchun", ru: "Клиентам" },
  ...
  "hero_tag": { uz: "Markaziy Osiyoning eskrou bozori", ru: "Эскроу-платформа Центральной Азии" },
  "hero_h1a": { uz: "Ko'nikmangizni soting, ishonchli mutaxassis yollang.", ru: "Продавайте навыки. Нанимайте проверенных профессионалов." },
  "hero_h1b": { uz: "Har bir to'lov xavfsiz.", ru: "Каждый платёж под защитой." },
  "hero_sub": { uz: "Bobo&Doda — bosqichli to'lov kafolati (eskrou) bilan ishlaydigan Markaziy Osiyo bozori: pul har bosqich qabul qilingandagina mutaxassisga o'tadi.", ru: "Bobo&Doda — маркетплейс Центральной Азии с поэтапной гарантией оплаты (эскроу): деньги переходят специалисту только после принятия каждого этапа." },
  "hero_cta1": { uz: "Mutaxassis sifatida boshlash", ru: "Начать как специалист" },
  "hero_cta2": { uz: "Mutaxassis yollash", ru: "Нанять специалиста" },
  ...
  "ps_h2": { uz: "Frilanser bozorlari nega ishonchsiz?", ru: "Почему фриланс-биржам не доверяют?" },
  ...
  "escrow_h2": { uz: "Eskrou himoyasi 4 bosqichda", ru: "Защита эскроу в 4 шага" },
  ...
  "step4_h": { uz: "To'lov chiqariladi", ru: "Оплата переводится" },
  "step4_p": { uz: "Ish qabul qilinishi bilan pul darhol mutaxassisga o'tadi.", ru: "После приёмки деньги сразу переводятся специалисту." },
  ...
  "pricing_h2": { uz: "Yashirin to'lovlarsiz", ru: "Без скрытых платежей" },
  ...
  "diff_h2": { uz: "An'anaviy frilans platformalaridan farqi", ru: "Отличие от классических фриланс-платформ" },
  ...
  "sec3_h": { uz: "Xavfsiz to'lovlar", ru: "Безопасные платежи" },
  "sec3_p": { uz: "Karta ma'lumotlari to'liq saqlanmaydi — faqat oxirgi 4 raqam.", ru: "Данные карты не хранятся полностью — только последние 4 цифры." },
  ...
  "cta_ready": { uz: "Ishonch bilan ishlashga tayyormisiz?", ru: "Готовы работать с уверенностью?" },
  "cta_desc": { uz: "Markaziy Osiyoda xavfsiz frilans kelajagini birga quramiz.", ru: "Давайте вместе построим безопасное будущее фриланса в Центральной Азии." },
  "cta_btn1": { uz: "Sotishni boshlash", ru: "Начать продавать" },
  "cta_btn2": { uz: "Hoziroq yollash", ru: "Нанять сейчас" },
