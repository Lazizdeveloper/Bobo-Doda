...
export const HELP_ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    related: ["taklif-yuborish-va-yollash", "sms-orqali-tasdiqlash"],
    keywords: ["profile", "profil", "bio", "trust badge"],
  },
  {
    slug: "sms-orqali-tasdiqlash",
    category: "account",
    title: {
      uz: "SMS orqali tasdiqlash",
      ru: "Верификация через SMS",
      en: "Verifying your account via SMS",
    },
    summary: {
      uz: "Ro'yxatdan o'tishda telefon raqamini tasdiqlash bosqichi qanday ishlaydi.",
      ru: "Как работает подтверждение номера телефона при регистрации.",
      en: "How the phone-number verification step during registration works.",
    },
    content: {
      uz: [
    ...
    keywords: ["verification", "tasdiqlash", "sms", "otp", "6 digit"],
  },
  {
