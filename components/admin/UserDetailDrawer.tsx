  ...
  return (
    ...
    >
              ...
              <Card className="space-y-3">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 pt-2 border-t border-line">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-amber-600">⭐ {profile.rating} / 5.0</p>
                  </div>
                  <div>
                ...
                {kycRecord.status === "korib_chiqilmoqda" && (
                  <div className="flex items-center gap-2 pt-2 border-t border-line">
                    <Button
                      ...
                      tone="success"
                      onClick={() => {
                        adminModerateKYC(user.id, "approve");
                        onUpdated();
                      }}
                    >
                      Hujjatni tasdiqlash
      ...
      <DangerousActionModal
        ...
        confirmTone="warning"
        onConfirm={(reason) => {
          suspendUser(user.id, reason, suspendDays);
          onUpdated();
        }}
      />
      ...
      <DangerousActionModal
        ...
        confirmTone="danger"
        onConfirm={(reason) => {
          adminModerateKYC(user.id, "reject", reason);
          onUpdated();
        }}
      />
    </Modal>
